(ns com.fabriclj.swiss-knife.client.debug-render
  "客户端调试渲染系统
   ...
   注意：此模块仅在客户端可用"
  (:require [com.fabriclj.swiss-knife.client.rendering :as render]
...
(comment
  ...
  ;; 注册渲染事件
  (require '[com.fabriclj.swiss-knife.client.events :as events])
