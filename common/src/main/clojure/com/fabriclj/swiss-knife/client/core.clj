(ns com.fabriclj.swiss-knife.client.core
  "瑞士军刀 - 客户端核心工具模块

   提供客户端专用的工具函数和访问器。

   注意：此命名空间仅在客户端环境可用！"
  (:require [com.fabriclj.swiss-knife.common.core :as common])
...
(defn get-crosshair-target
  "获取准星指向的目标
   ...
   返回：HitResult（BlockHitResult 或 EntityHitResult）"
  ^HitResult []
